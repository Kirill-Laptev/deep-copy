    ...
    let man6FullCopy = {
        ...
        mother: {
            ...
            parents: man6.mother.parents.map((parent) => ({...parent, favoriteDish: {...parent.favoriteDish}}))
        }
    }
        ...
        mother: {
            ...
            parents: man7.mother.parents.map((parent) => {
                return {
                    ...
                    favoriteDish: {
                        ...parent.favoriteDish,
                        ingredients: parent.favoriteDish.ingredients.map((ingridient) => ({...ingridient}))
                    }
                }
            })
        }
    ...
    man7.mother.new = 'new'
    man7.mother.work.new = 'new'
    man7.mother.parents.push({new: 'new'})
    man7.mother.parents[0].age = 1000
    man7.mother.parents[0].favoriteDish.new = 'new'
    man7.mother.parents[0].favoriteDish.ingredients.push({new: 'new'})
